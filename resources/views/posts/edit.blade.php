        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="col-md-12">
                    <form method="POST" 
                        action="{{ url('/editPost', array($posts->id)) }}"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea id="post_body" rows="7" class="form-control{{ $errors->has('post_body') ? ' is-invalid' : '' }}" 
                                name="post_body" required>{{ $posts->post_body }}</textarea>
